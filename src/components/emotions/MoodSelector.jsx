  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
      <div className="bg-white dark:bg-gray-800 rounded-3xl w-full max-w-2xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-purple-600 p-8 relative overflow-hidden">
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${isSelected 
                        ? `${mood.color} ${mood.darkColor} shadow-lg scale-105 ring-4 ring-white dark:ring-gray-700` 
                  ...
                  >
                    <div className="flex flex-col items-center gap-2">
                      {Icon && (
                        <Icon className="w-8 h-8 text-gray-800 dark:text-white transition-transform group-hover:scale-110" strokeWidth={2.5} />
                      )}
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 px-6 py-3 rounded-xl border-2 border-gray-300 dark:border-gray-600
                ...
                hover:bg-gray-100 dark:hover:bg-gray-700 transition-all active:scale-95"
            >
              Cancelar
            </button>
            <button
